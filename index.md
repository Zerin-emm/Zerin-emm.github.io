...
### 
[Zerin-emm/idv-login](https://github.com/Zerin-emm/idv-login)
idv-login 是一个第五人格登录器, 可以免发烧平台登录游戏.该版本fork自[KKeygen/idv-login](https://github.com/KKeygen/idv-login) 仅保留官服登录支持,去除了渠道服登录支持/web页面/游戏下载,体积仅106MB,相当于原版的15%.
